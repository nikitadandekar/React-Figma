...
function Footer() {
  return (
    <div className=" w-[1440px] h-[268px] mt-32">
      <div className="flex m-auto w-[1219px] h-[161px] gap-11 mt-28 ml-52 mb-11">
        <div>
      ...
      <div className="">
        <div className="text-[13px] font-normal text-[#686868] text-center pt-10 border-t-2 border-[rgba(#686868)]">
