...
import images49 from "../Images/focus.png";
import images50 from "../Images/purple.png";
import images51 from "../Images/happy.png";
import Circle2 from "../Images/Ellip2.png";
function Lorem4() {
  return (
    <div className=" h-[534px] flex  gap-16 pt-28">
      ...
      <div className="">
        <img className="absolute z-30 ml-[21%]" src={Circle2} />
        <img className="relative bottom-20 right-36" src={images49} />
      </div>
    </div>
  );
}
